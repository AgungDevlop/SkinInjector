            ...
            >
              <div className="flex items-center gap-2">
                ...
                <img
                  ...
                  className={`w-9 h-9 object-cover rounded-full border-2 ${colors.border} ${loadedImages.has(`${recall.id}-img1`) ? '' : 'hidden'}`}
                  loading="lazy"
                  decoding="async"
                />
                ...
                <img
                  ...
                  className={`w-9 h-9 object-cover rounded-full border-2 ${colors.border} ${loadedImages.has(`${recall.id}-img2`) ? '' : 'hidden'}`}
                  loading="lazy"
                  decoding="async"
                />
