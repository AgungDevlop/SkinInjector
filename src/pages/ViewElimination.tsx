              ...
              <>
                ...
                <p className="info-text">
                  {progress.status === "Downloading..."
                    ? "Mengunduh Elimination..."
                    : progress.status === "Extracting..."
                    ? "Mengekstrak Elimination..."
                    : "Pemasangan Selesai"}
                </p>
                {progress.status !== "Completed" && (
                  <p className="warning-text">
                    <strong>Indonesia:</strong> Jangan close aplikasi sebelum script elimination selesai dipasang.<br />
                    <strong>Inggris:</strong> Do not close the app until the elimination script is fully installed.
                  </p>
                )}
              </>
            )}
