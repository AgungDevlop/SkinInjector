...
const ViewSpawn: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p Napapun -2 sm:p-4 relative">
      <style>
        {`
              ...
              <>
                ...
                {progress.status !== "Completed" && (
                  <p className="warning-text">
                    <strong>Indonesia:</strong> Jangan close aplikasi sebelum script spawn selesai dipasang.<br />
                    <strong>Inggris:</strong> Do not close the app until the spawn script is fully installed.
                  </p>
                )}
              </>
            )}
